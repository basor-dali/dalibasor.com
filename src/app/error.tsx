...
export default function ErrorBoundary({
  ...
  return (
    <div className="u-page pt-36 pb-(--spacing-section) sm:pt-44">
      <hr className="u-rule" />
      <p className="u-label mt-5 text-ember">Something broke</p>
      ...
      <div className="u-grid mt-14 items-end sm:mt-20">
        ...
        <div className="col-span-2 md:col-span-6 lg:col-span-5 lg:pb-4">
          <p className="u-serif max-w-(--container-text) text-xl text-soft">
            Nothing is lost. This is a rendering fault, not a missing page — try it again, and the
      ...
      <div className="mt-(--spacing-section-sm) flex flex-wrap items-center gap-x-10 gap-y-5 border-t border-line pt-10">
        <button
          type="button"
          onClick={reset}
          className="u-label border border-line-strong px-6 py-4 text-ivory transition-colors duration-300 hover:border-ember hover:text-white"
        >
          Try again
        </button>
